...
public class TrainingPauseBetweenSetsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_training_pause_between_sets, container, false);
        activity = (TrainingActivity) getActivity();
        timerTextView = view.findViewById(R.id.timerTextView);
        long pauseDuration = activity.getCurrentTrainingWorkout().getDurationOfPauseBetweenSets();
