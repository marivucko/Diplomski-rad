...
import com.gymdroid.view.details_done_workout.reps.SetWidthTimeView;

import java.util.ArrayList;

@SuppressLint("ViewConstructor")
public class DetailsDoneWorkoutRepsWithTime extends LinearLayout {
    ...
    public DetailsDoneWorkoutRepsWithTime(final Activity activity, ViewGroup parent, DoneWorkout doneWorkout, int numeration) {
        super(activity);

        LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(parent.getContext()).inflate( R.layout.view_details_done_workout_reps_with_time, parent, false);
        ...
        for(int i = 0; i < doneSetArrayList.size(); i++) {
            ...
            doneRepsLinearLayout.addView(new SetWidthTimeView(activity,parent,numberOfReps,time));
        }
